...
async function populateTestData() {
    ...
    const employee2 = await employeeService.createEmployee(profile2._id, company._id, salesDepartment._id, 'Sales Associate');
    const employee3 = await employeeService.createEmployee(profile3._id, company._id, hrDepartment._id, 'HR Manager');
    const employee4 = await employeeService.createEmployee(profile4._id, company._id, hrDepartment._id, 'HR Specialist');
    ...
    departmentService.addEmployee(managementDepartment._id, supervisorEmployee._id);
