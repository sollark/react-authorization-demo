...
router.post('/update', requireAuth, accountSchema, validateRequest, asyncHandler(updateAccount));
router.post('/join', requireAuth, accessSchema, validateRequest, asyncHandler(joinCompany));
