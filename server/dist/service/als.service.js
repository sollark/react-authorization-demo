...
import { default as logger, default as loggerService, } from './logger.service.js';
export const asyncLocalStorage = new AsyncLocalStorage();
export function setUuidToALS(uuid) {
...
export function setRequestDataToALS(requestData) {
    ...
    logger.info(`setRequestDataToALS - requestData: ${JSON.stringify(requestData)}`);
}
...
export function getEmployeeNumberFromALS() {
    ...
    if (!employeeNumber) {
        ...
        loggerService.info(`getEmployeeNumberFromALS - employeeNumber: ${employeeNumber}`);
